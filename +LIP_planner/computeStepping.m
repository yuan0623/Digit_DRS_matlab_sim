function [px_sp2sw, py_sp2sw] = computeStepping(p_sp2CoM, Ly_est, Lx_est, foot_index, LIP_para, t_end_desired)
    Ly_des = LIP_para.m * LIP_para.H * LIP_para.v_des;
    [px_sw2CoM, py_sw2CoM] = LIP_planner.computeSw2CoM(Ly_est, Lx_est, Ly_des, foot_index, LIP_para, t_end_desired);
