function L_foot_pose = digit_left_foot_pose_vehicle(q)
    ...
    Z_L_foot = Z_L_foot(1);
    Lr21 = Tb2left_toe(2,1);
    Lr21 = Lr21(1);
    Lr11 = Tb2left_toe(1,1);
    Lr11 = Lr11(1);
    Lr31 = Tb2left_toe(3,1);
    Lr31 = Lr31(1);
    Lr32 = Tb2left_toe(3,2);
    Lr32 = Lr32(1);
    Lr33 = Tb2left_toe(3,3);
    Lr33 = Lr33(1);
    LPitch = atan2(-Lr31,sqrt(Lr32*Lr32+Lr33*Lr33));
    LYaw = atan2(Lr21,Lr11);
    LRoll = atan2(Lr32,Lr33);
    L_foot_pose = [X_L_foot;Y_L_foot;Z_L_foot;LRoll;LPitch;LYaw];
